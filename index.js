...
(async () => {
    ...
    while (true) {
        ...
        if (values.length !== 0) {
            console.log("____FOUND_NEW_PAIR____")
            console.log(values)
            console.log("____FOUND_NEW_PAIR_DATE____")
            console.log(new Date())
            console.log("____START_TRADING____")
